  ...
  selector.addEventListener('click', () => {
    ...
    if(index != activeSlide){
        ...
        if(index == 0){
            ...
            document.getElementsByClassName("sliderFrame")[0].style.backgroundColor = 'var(--strawberry)'
        }else if(index == 1){   
            ...
            document.getElementsByClassName("sliderFrame")[0].style.backgroundColor = 'var(--kiwi)'
        }else if(index == 2){
            document.getElementsByClassName("navmiddle")[0].classList.remove("dark")
            document.getElementsByClassName("shopCart")[0].classList.remove("dark")
            document.getElementsByClassName("sliderFrame")[0].style.backgroundColor = 'var(--lemonMint)'
        }
